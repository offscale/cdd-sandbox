...
var RPC;
(function (RPC) {
    function call(servername, host, method, params, callback) {
        var _this = this;
        ...
        try {
            client.connect(host, function () {
                try {
                    client.send(method, params, function (error, response) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            if (error != null) {
                                console.error("rpc-error-response: " + servername + "/" + method + ": ", error.message);
                            }
                            else {
                                console.log("rpc-response: " + servername + " -> " + method, response);
                                callback(response);
                            }
                            return [2 /*return*/];
                        });
